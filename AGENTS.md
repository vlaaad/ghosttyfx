...
Project context: released library, brings Ghostty (./ghostty) to Java/JavaFX (implementation in ./ghosttyfx-core, current-platform convenience artifact in ./ghosttyfx), inspired by Ghostling (./ghostling/main.c); goal - implement terminal ui using jextract-generated bindings of libghostty and javafx to give a UX similar to ghostty.
