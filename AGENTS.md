...
Code: data-driven - final classes, interfaces, records, lambdas; prefer var; fail-fast: check on edges, trust internals; prefer local reasoning; extract helpers only for real reuse or domain concepts.
